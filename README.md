# smart-attendance-management-system is  an automatic attendance marking application developed in python using machine learning and deep learning.User can run this using ams4.py.
